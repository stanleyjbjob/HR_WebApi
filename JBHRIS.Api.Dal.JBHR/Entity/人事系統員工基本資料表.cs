...
{
    public partial class 人事系統員工基本資料表
    {
        ...
        public DateTime? 居留證起始日 { get; set; }
        public DateTime? 居留證到期日 { get; set; }
        public string 轉帳行號 { get; set; }
        ...
        public string 離職原因 { get; set; }
        public string 異動原因代碼 { get; set; }
        public string 異動原因 { get; set; }
        public string 工作地 { get; set; }
        public DateTime 異動生效日 { get; set; }
